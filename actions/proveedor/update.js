...
module.exports = class DefaultCreateAction extends BaseAction {
  ...
  _validate() {
    ...
    if (this.body.cedula) this.validateCedula(this.body.tipoCedula, this.body.cedula);
  }
  ...
  validateCedula(tipo, cedula) {
    ...
    else if (!tipo || ["Físicia", "Jurídica"].indexOf(tipo) == -1) throw new Errors.VALIDATION_ERROR(`La cedula o el tipo no es valido`, [{ type: "cedula" }, { type: "tipoCedula" }]);
  }
